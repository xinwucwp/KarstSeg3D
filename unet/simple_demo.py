...
if __name__ == '__main__':
  ...
  #volume = np.memmap('../../efault/data/lspTrain/noise/86.dat',dtype='>f4',mode='r',shape=(128,128,128))
  volume = np.fromfile('../../efault/data/lspTrain/noise/86.dat',dtype=np.single).reshape(128,128,128)

  axis_scales = (1, 1, 1) # isotropoic axes

  visual_nodes = volume_slices(volume,
    x_pos=100, y_pos=120, z_pos=30,

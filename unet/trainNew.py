...
class TrainValTensorBoard(TensorBoard):
    def __init__(self, log_dir='./log3', **kwargs):
...
# checkpoint
filepath="check3/checkpoint.{epoch:02d}.hdf5"
...
sxpath = '/media/xinwu/disk-2/karst/noise/'
kxpath = '/media/xinwu/disk-2/karst/karst/'
n1,n2,n3,nd=512,512,512,5
tdata_ids = range(0,90)
vdata_ids = range(90,100)
